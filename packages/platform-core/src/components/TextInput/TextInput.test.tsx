...
describe('TextInputField::', () => {
  it('should render an input element of type text', () => {
    const wrapper = mount(<Wrapper><TextInputField name="test" /></Wrapper>);
  ...
  it('should call passed validators', () => {
    ...
    const wrapper = mount(<Wrapper><TextInputField name="test" validators={[validatorOne, validatorTwo]} /></Wrapper>);
  ...
  it('should show validation errors on blur if specified', () => {
    ...
    const wrapper = mount(<Wrapper><TextInputField showErrorOnBlur name="test" validators={[validatorOne, validatorTwo]} /></Wrapper>);
  ...
  it('should show a label if one is specified', () => {
    const wrapper = mount(<Wrapper><TextInputField label="test label" name="test" /></Wrapper>);
  ...
  it('should show an asterisk on the label if the field is required', () => {
    const wrapper = mount(<Wrapper><TextInputField label="test label" name="test" required /></Wrapper>);
  ...
  it('should hide arrow buttons when disabled', () => {
    const wrapper = mount(<Wrapper><TextInputField name="test" disabled /></Wrapper>);
  ...
  it('should apply the passed class name to the inner input element', () => {
    const wrapper = mount(<Wrapper><TextInputField name="test" className="testClass" /></Wrapper>);
